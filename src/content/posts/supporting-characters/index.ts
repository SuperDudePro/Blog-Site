...
const post: BlogPost = {
  ...
  bodyHtml: `
    ...
    <p>So there are two ways to be satisfied. The satisfied I went after in the last post is the dead kind — settled-for, furniture-comfortable, miserable but not moving. The other kind belongs to people who never thought they were main characters at all. They took the supporting role on wholly, and once in a while that's exactly what turned one of them into a main character. It doesn't run in reverse. Chasing main character produces pretenders — that's most of politics. Not main characters. Pretenders. The people who feel imposter syndrome and deserve it.</p>
    ...
    <p>That cell is where my question finally fell apart. Why would I be here if I wasn't a main character? Wrong question. For five days I was the main character of the worst story I've ever lived, and it felt nothing like the thing I'd spent my life wanting. What held me together were five men who took the supporting role on wholly — for a stranger, for nothing anybody would ever record.</p>

    <p>The harder peace came later, when I had to give up the last piece of the fantasy — the piece where I at least get to know what my part is. Maybe my part is Xander. Maybe it's Raven. Maybe it's one sentence I say to a stranger at exactly the right moment, and I never find out, and it was never about my family at all. Those five men will never know what those five days did. That's the deal. You don't get the receipt.</p>
