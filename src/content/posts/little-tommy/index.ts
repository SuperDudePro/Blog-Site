...
const post: BlogPost = {
  ...
  heroImage,
  heroAlt:
    'An anonymous IBM employee sorting old photographs and writing a Little Tommy letter in an office overlooking Boulder Reservoir.',
  cardImage,
  cardAlt:
    'A worn envelope marked Little Tommy resting on a scattered pile of duplicate photographs.',
  bodyHtml: `
    <p>Sometime around 1995, I was living in a house on Caribou Ranch outside Nederland with two roommates, Brent and Reggie.</p>
    ...
    <p>Reggie was about six years older than me. I met him not long after I started working in Colorado, and he ended up connected to me through a bunch of different people and jobs and houses and whatever else. Eventually the three of us were living in that house on Caribou Ranch.</p>
    <p>That's more background than this story needs, except that this was before the internet gave everybody a thousand little ways to waste the day.</p>
    ...
    <p>So there was a lot of hanging around. Reading. Walking. Going out by Boulder Reservoir. Sitting in an office pretending the empty hours had some professional shape to them.</p>
    ...
    <p>At some point, I ended up with a huge pile of photos I was going to get rid of. And then, instead of throwing them away like a normal person, I got an idea.</p>
    ...
    <div class="post-center">
      Hi.<br /><br />
      I thot you wood like these pitures.<br />
      I hope you like them.<br /><br />
      Love,<br />
      Little Tommy
    </div>

    <p>Something like that. I don't remember the exact wording anymore, but that was the voice. Not cute exactly. Not fully threatening. Just wrong enough that you had to decide what kind of wrong it was.</p>
    <p>I wrote them by hand again and again at IBM, which is a good use of corporate time if you measure corporate time by historical value.</p>

    <figure class="post-figure">
      <img src="${bodyImageOne}" alt="A childlike Little Tommy note with misspelled words lying beside four unrelated old photographs." loading="lazy" decoding="async" />
    </figure>
    ...
    <p>So I boxed the envelopes up and sent them to my sister in the Chicago suburbs. She mailed them from there, so the postmark said something general like South Suburban, Illinois.</p>

    <figure class="post-figure">
      <img src="${bodyImageTwo}" alt="Hands packing childish letters and random photographs into stamped envelopes beside a paper address book." loading="lazy" decoding="async" />
    </figure>

    <p>That was enough fog.</p>
    ...
    <figure class="post-figure">
      <img src="${bodyImageThree}" alt="A puzzled recipient arranging unrelated photographs into an elaborate imagined connection at a kitchen table." loading="lazy" decoding="async" />
    </figure>
    ...
    <div class="post-center">
      What's wrong?<br /><br />
      Didn't you like the pictures I sent?<br />
      I thought you wood like them.<br />
      Here are some more.
    </div>
    ...
    <div class="post-center">
      Hey.<br /><br />
      I sent you two sets of pitures.<br />
      Why are you still ignoring me?<br />
      What is wrong?<br />
    ...
    <figure class="post-figure">
      <img src="${bodyImageFour}" alt="Three Little Tommy letters progressing from friendly to disappointed to angry in increasingly forceful handwriting." loading="lazy" decoding="async" />
    </figure>
    ...
    <p>Have you ever turned something meaningless into a whole story—or mailed anyone anything this stupid? <a href="https://ourolddad.com/contact">Let us know through the contact page.</a></p>
  `,
};
