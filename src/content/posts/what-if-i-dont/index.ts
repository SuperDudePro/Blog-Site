...
const post: BlogPost = {
  ...
  status: 'Recent',
  heroImage,
  heroAlt: 'A father and two children walk through a school hallway toward an open exit as fear questions cover the walls.',
  cardImage,
  cardAlt: 'A hand hesitates over the push bar of a school exit door.',
  bodyHtml: `
    ...
    <figure class="post-figure">
      <img src="${bodyImageOne}" alt="Headphones and a notebook sit on a table as the headphone cable curls into a question mark." loading="lazy" decoding="async" />
    </figure>
    ...
    <figure class="post-figure">
      <img src="${bodyImageThree}" alt="A rough road detours around a washout and fallen branch before reconnecting with the route ahead." loading="lazy" decoding="async" />
    </figure>
    ...
    <figure class="post-figure">
      <img src="${bodyImageTwo}" alt="Two dice rest on a scratched school desk beside a backpack hanging from the chair." loading="lazy" decoding="async" />
    </figure>
    ...
    <figure class="post-figure">
      <img src="${bodyImageFour}" alt="A roadside guardrail transforms into an open leash lying loose beside the road." loading="lazy" decoding="async" />
    </figure>
