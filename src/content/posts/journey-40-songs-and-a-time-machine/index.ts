...
const post: BlogPost = {
  ...
  status: 'Recent',
  heroImage,
  heroAlt: 'Wide pencil-sketch montage of records and a turntable in the foreground, with ghosted memories of a concert, a nighttime drive, and a school dance behind.',
  cardImage,
  ...
  bodyHtml: `
    ...
    <figure class="post-figure">
      <img src="${bodyImageFour}" alt="Pencil-sketch collage of Journey records and cassettes with concert, highway, and car memories arranged behind them in purple and charcoal." loading="lazy" decoding="async" />
    </figure>
