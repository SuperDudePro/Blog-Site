...
const post: BlogPost = {
  ...
  status: 'Recent',
  heroImage,
  heroAlt: 'Black, cream, gold, and neon-purple OOD Playlists banner for Journey: 40 Songs and a Time Machine, with the bearded skull mascot, a record, and waveform ornaments.',
  cardImage,
